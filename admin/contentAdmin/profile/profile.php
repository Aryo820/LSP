...
if (isset($_GET['delete_kualifikasi'])) {
    ...
    if ($tableCheck && mysqli_num_rows($tableCheck) > 0) {
        ...
        if ($deleteQuery) {
            header("Location: ?page=profile/profile&delete=Berhasil%dihapus");
            exit;
        }
    }
}
        ...
        <!-- KUALIFIKASI PENDIDIKAN -->
            ...
            <div class="row mt-4">
                <div class="col-12">
                  ...
                  <h3 class="h4 mb-1">LIST KUALIFIKASI PENDIDIKAN SAAT INI</h3>
                  <div class="card shadow">
                    <div class="card-body">
                      <div class="toolbar">
                        <form class="form">
                                        ...
                                        if ($queryKualifikasi && mysqli_num_rows($queryKualifikasi) > 0) {
                                            while ($rowKualifikasi = mysqli_fetch_assoc($queryKualifikasi)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="?page=profile/profile&delete_kualifikasi=<?= $rowKualifikasi['id'] ?>" 
