            ...
            <div class="form-group mb-3">
                ...
                <select class="form-control" id="jenjang_pendidikan" name="jenjang_pendidikan">
                    <?php
                        ...
                        $savedJenjang = isset($rowUser['jenjang_pendidikan']) ? $rowUser['jenjang_pendidikan'] : '';
                    ?>
                    <option value="" disabled <?= empty($savedJenjang) ? 'selected' : '' ?>>Select One</option>
                    <?php foreach ($optJenjang as $j): ?>
                        <option value="<?= $j ?>" <?= (strtolower($savedJenjang) === strtolower($j)) ? 'selected' : '' ?>><?= $j ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input 
                            ...
                            value="<?= isset($rowUser['instansi_pendidikan']) ? $rowUser['instansi_pendidikan'] : '' ?>" 
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input 
                            ...
                            id="tahun_lulus" 
                            name="tahun_lulus" 
                            value="<?= isset($rowUser['tahun_lulus']) ? $rowUser['tahun_lulus'] : '' ?>" 
